...
;window.mini || (function($) {
	...
	w.dialog=(function(){
		...
		return function(cfg){
			...
			**/
			...
			//返回对象，对框的很多操作依靠这个对象
			var obj={el:content,content:ct,border:b,level:div,overlay:overlay,show:show,hide:hide,setContent:setContent,setTitle:setTitle,setHtml:setHtml};
			return obj;
		}
	})();
	/**
	...
	**/
	w.alert=function(msg,callback){
		...
		var d=w.dialog({
			...
			,buttons:[{text:'确定',callback:function(){d.hide()}}]
		});
	}
	w.confirm=function(msg,callback,cancel){
		...
		var d=w.dialog({
			...
			,buttons:[{text:'确定',callback:function(){d.hide(false);if(callback)callback()}}
			,{text:'取消',callback:function(){d.hide()}}]
		});
	}
	/**
	...
	*/
	...
	w.button=function(cls,obj){
		...
		i.appendTo(b);
		b.hover(function(){b.addClass(hCls)},function(){b.removeClass(hCls)}).addClass(cls).addClass("formField");
		return b;
	}
	w.input=function(cls,obj){
		...
		i.appendTo(b);
		o.focus(function(){b.addClass(hCls)}).blur(function(){b.removeClass(hCls)});
	...
	w.inputFile=function(cls,obj){
		...
		setTimeout(function(){
			...
			var of=b.offset();
			o.focus(function(){p.addClass(hCls)}).blur(function(){p.removeClass(hCls)});
			o.change(function(){
				i.text($(this).val());
			});
			...
			o.hover(function(){button.addClass("buttonHover")},function(){button.removeClass("buttonHover")});
